...
def edge_detection(a, b, parents, children, data, ind_collection, cit_test = "fisherz", alpha = 0.001):
    '''
    Inputs:
...
def path_tracing(topo_sort, data, cit_test = "fisherz", alpha = 0.001):
    '''
    Inputs:
    ...
    for i in range(1,d):
        ...
        for j in range(i-1,-1,-1):
            ...
            if b in ind_collection[a]:
                parents, children = edge_detection(a,
                                                   b,
                                                   parents,
                                                   children,
                                                   data,
...
def marg_ind(data, cit_test = "fisherz", alpha = 0.001):
    '''Inputs: 
